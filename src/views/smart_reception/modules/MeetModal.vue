<template>
  ...
  >
    ...
    <smart_8-escorted-meal-list ref="realForm" @ok="submitCallback" :disabled="disableSubmit" />
  </j-modal>
</template>

<script>
import { getAction } from '../../../api/manage'
import Smart_8EscortedMealList from "./Smart_8EscortedMealList";

export default {
  name: 'MeetModal',
  components: {
    Smart_8EscortedMealList
  },
  data() {
    return {
      title: '',
