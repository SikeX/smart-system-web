<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('来访人员信息表')">导出</a-button>
      <a-upload
        name="file"
    ...
    <smart_8Visitor-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></smart_8Visitor-modal>
  </a-card>
</template>
...
<script>
  ...
  import Smart_8VisitorModal from './modules/Smart_8VisitorModal'

  export default {
    name: "Smart_8VisitorList",
    mixins:[JeecgListMixin],
    components: { Smart_8VisitorModal },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          list: "/smart_reception/smartReception/listSmart_8VisitorByMainId",
          delete: "/smart_reception/smartReception/deleteSmart_8Visitor",
          deleteBatch: "/smart_reception/smartReception/deleteBatchSmart_8Visitor",
          exportXlsUrl: "/smart_reception/smartReception/exportSmart_8Visitor",
          importUrl: "/smart_reception/smartReception/importSmart_8Visitor",
        },
        dictOptions:{
         departmentId:[],
         stay:[],
