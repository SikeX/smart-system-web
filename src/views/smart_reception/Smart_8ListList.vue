<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('接待清单')">导出</a-button>
      <a-upload
        name="file"
    ...
    <smart_8List-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></smart_8List-modal>
  </a-card>
</template>
...
<script>
  ...
  import Smart_8ListModal from './modules/Smart_8ListModal'

  export default {
    name: "Smart_8ListList",
    mixins:[JeecgListMixin],
    components: { Smart_8ListModal },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          list: "/smart_reception/smartReception/listSmart_8ListByMainId",
          delete: "/smart_reception/smartReception/deleteSmart_8List",
          deleteBatch: "/smart_reception/smartReception/deleteBatchSmart_8List",
          exportXlsUrl: "/smart_reception/smartReception/exportSmart_8List",
          importUrl: "/smart_reception/smartReception/importSmart_8List",
        },
        dictOptions:{
         departmentId:[],
         stay:[],
