<template>
  <j-modal
    ...
    <smart-org-meeting-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>

  import SmartOrgMeetingForm from './SmartOrgMeetingForm'
  import {getAction} from "../../../api/manage"

  export default {
    name: 'SmartOrgMeetingModal',
    components: {
      SmartOrgMeetingForm
    },
    data() {
