  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/smart_data_sheet/smartDataSheet/list",
          delete: "/smart_data_sheet/smartDataSheet/delete",
          deleteBatch: "/smart_data_sheet/smartDataSheet/deleteBatch",
          exportXlsUrl: "/smart_data_sheet/smartDataSheet/exportXls",
          importExcelUrl: "smart_data_sheet/smartDataSheet/importExcel",
