<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="类型">
              <j-dict-select-tag placeholder="请选择类型" v-model="queryParam.type" dictCode="publicity_category" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <smart-publicity-party-modal ref="modalForm" @ok="modalFormOk"></smart-publicity-party-modal>
  </a-card>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        importExcelUrl: 'smartPublicityParty/smartPublicityParty/importExcel',
      },
      dictOptions: {},
      superFieldList: [],
    }
  ...
  methods: {
    ...
    getSuperFieldList() {
      let fieldList = []
      fieldList.push({ type: 'string', value: 'type', text: '类型', dictCode: 'publicity_category' })
      fieldList.push({ type: 'sel_depart', value: 'location', text: '单位' })
