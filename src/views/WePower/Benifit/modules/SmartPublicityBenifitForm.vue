        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="类别" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="type">
              <a-input v-model="model.type" placeholder="请输入类别"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="应用范围" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="location">
              <select-village-street-depart v-model="model.location" multi />
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        add: '/smartPublicityBenifit/smartPublicityBenifit/add',
        edit: '/smartPublicityBenifit/smartPublicityBenifit/edit',
        queryById: '/smartPublicityBenifit/smartPublicityBenifit/queryById',
      },
    }
  },
  computed: {
