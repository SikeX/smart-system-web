  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="所属村" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="village">
          ...
          <a-col :span="24">
            <a-form-model-item label="人员类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="type">
              <j-dict-select-tag type="list" v-model="model.type" dictCode="lead_people_type2" placeholder="请选择人员类型" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
    ...
    data () {
      return {
        ...
        validatorRules: {
           ...
           idnumber: [
              { required: false},
              { pattern: '(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}$)', message: '请输入正确的身份证号!'},
           ],
           pic: [
