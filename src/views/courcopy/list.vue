<template>
  <div class="app-container">
    实验列表
    <el-table v-bind="listLoading" :data="list" element-loading-text="数据加载中" border fit highlight-current-row
      ><router-view />
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" icon="el-icon-edit" @click="updateInfo(scope.row.id)"
            >编辑基本信息
          </el-button>
          <el-button type="primary" size="mini" icon="el-icon-edit" @click="updateChapter(scope.row.id)"
            >编辑实验大纲</el-button
          >
          <!--          </router-link>-->
          <!--          <el-form-item>-->
