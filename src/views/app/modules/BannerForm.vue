        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="图片链接" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="url">
              <j-image-upload :isMultiple="false" v-model="model.url"></j-image-upload>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        title: [{ required: true, message: '请输入banner备注标题!' }],
        url: [{ required: true, message: '请输入图片链接!' }],
        sort: [{ required: true, message: '请输入排序!' }],
      },
      url: {
        add: '/app/banner/add',
        edit: '/app/banner/edit',
        queryById: '/app/banner/queryById',
      },
    }
  },
  computed: {
