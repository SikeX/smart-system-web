<template>
  <a-card :body-style="{ padding: '24px 32px' }" :bordered="false">
    <a-form @submit="handleSubmit" :form="form" ref="evaluateForm">
      ...
      >
        <a-input
          v-decorator="['exeDept', { rules: [{ required: true, message: '主管单位' }] }]"
          name="exeDept"
          placeholder="主管单位"
        />
      </a-form-item>
      ...
      >
        <a-input
          ...
          v-decorator="['windowsName', { rules: [{ required: true, message: '窗口服务大厅名称' }] }]"
        />
      </a-form-item>
      <a-form-item
        label="人员ID"
      ...
      <a-form-item
        ...
        :wrapperCol="{ lg: { span: 10 }, sm: { span: 17 } }"
      >
        <a-input v-decorator="['personName']" placeholder="被评价人姓名" />
      </a-form-item>
      <a-form-item
        label="评价人姓名"
        :labelCol="{ lg: { span: 7 }, sm: { span: 7 } }"
        :wrapperCol="{ lg: { span: 10 }, sm: { span: 17 } }"
      >
        <a-input v-decorator="['evaluateName', validatorRules.evaluateName]" placeholder="请输入评价人姓名" />
      </a-form-item>
      <a-form-item
        label="评价人手机号"
        :labelCol="{ lg: { span: 7 }, sm: { span: 7 } }"
        :wrapperCol="{ lg: { span: 10 }, sm: { span: 17 } }"
      >
        <a-input v-decorator="['evaluatePhone', validatorRules.evaluatePhone]" placeholder="请输入评价人手机号" />
      </a-form-item>
      <a-form-item
        label="评价时间"
        :labelCol="{ lg: { span: 7 }, sm: { span: 7 } }"
        ...
        v-show="false"
      >
        <a-input placeholder="选择日期" style="width: 100%" v-decorator="['evaluateTime']" />
      </a-form-item>
      <a-form-item
        label="满意度评价"
        :labelCol="{ lg: { span: 7 }, sm: { span: 7 } }"
      ...
      >
        <span>
          <a-rate v-decorator="['evaluateResult']" :tooltips="desc" />
        </span>
      </a-form-item>
      <a-form-model-item
        label="意见"
      ...
      >
        <a-textarea v-decorator="['evaluateOpinion']" placeholder="请输入意见" />
      </a-form-model-item>

      <a-form-item :wrapperCol="{ span: 24 }" style="text-align: center">
        <a-button htmlType="submit" type="primary">提交</a-button>
        <!--        <a-button style="margin-left: 8px" href	='../../QRCode/QRcode'>取消</a-button>-->
        <a-button type="primary" href="../../InsertReportingInformation/InsertReportingInformationDetail"
          >去举报</a-button
        >
      </a-form-item>
    </a-form>
