<template>
  <a-card title='评分考核单位管理' :bordered="false">
    <!-- 查询区域 -->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/smartAssessmentDepartment/smartAssessmentDepartment/list",
          delete: "/smartAssessmentDepartment/smartAssessmentDepartment/delete",
          deleteBatch: "/smartAssessmentDepartment/smartAssessmentDepartment/deleteBatch",
          exportXlsUrl: "/smartAssessmentDepartment/smartAssessmentDepartment/exportXls",
          importExcelUrl: "smartAssessmentDepartment/smartAssessmentDepartment/importExcel",
