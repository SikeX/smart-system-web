            ...
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="会议时间">
                <j-date
                  ...
                  v-model="queryParam.meetingTime_begin"
                ></j-date>
                ...
                <j-date
                  ...
                  placeholder="请选择结束时间"
                  class="query-group-cust"
                  v-model="queryParam.meetingTime_end"
                ></j-date>
              </a-form-item>
            </a-col>
          </template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        verify: 'smartDemocraticLifeMeeting/smartDemocraticLifeMeeting/submitVerify',
      },
      dictOptions: {},
      superFieldList: [],
    }
  ...
  methods: {
    initDictConfig() {},
    downlModel() {
      window.open(`${window._CONFIG['staticDomainURL']}/models/民主生活会导入模板.xls`)
    },
    getSuperFieldList() {
      let fieldList = []
