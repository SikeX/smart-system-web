          ...
          <a-row :gutter="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="职级">
                <j-search-select-tag
                  placeholder="请输入或选择职级"
                  v-model="queryParam.positionRank"
                  dict="position_rank"
                />
              </a-form-item>
            </a-col>
...
export default {
  ...
  methods: {
    ...
    getTotal() {
      let that = this
      getAction('/SmartPunishPeople/smartPunishPeople/punishPeopleCount')
        .then((res) => {
          if (res.success) {
      ...
      getAction('/SmartPunishPeople/smartPunishPeople/punishPeopleCountByMonth')
        .then((res) => {
          if (res.success) {
            //that.$message.success(res.message);
      ...
      getAction('/SmartPunishPeople/smartPunishPeople/punishPeopleCountByType')
        .then((res) => {
          if (res.success) {
            //that.$message.success(res.message);
