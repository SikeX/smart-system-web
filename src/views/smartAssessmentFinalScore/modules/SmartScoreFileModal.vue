          ...
          <a-row>
            <a-col :span='24'>
              <a-form-model-item label='附件说明' :labelCol='labelCol' :wrapperCol='wrapperCol'
                ...
                <a-textarea v-model='model.attachmentDescription' rows='4' placeholder='无附件说明'/>
              </a-form-model-item>
            </a-col>
            <a-col :span='24'>
              <a-form-model-item label='工作开始时间' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='workTime'>
                <j-date placeholder='无工作开始时间' v-model='model.workTime' :show-time='true'
            ...
            <a-col :span='24'>
              <a-form-model-item label='上报人' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='uploadUser'>
                <j-select-user-by-dep v-model='model.uploadUser' placeholder='无上报人'></j-select-user-by-dep>
              </a-form-model-item>
            </a-col>
            <a-col :span='24'>
              <a-form-model-item label='上传时间' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='createTime'>
                <j-date placeholder='无上传时间' v-model='model.createTime' :show-time='true'
                        date-format='YYYY-MM-DD HH:mm:ss'
                        style='width: 100%'/>
              </a-form-model-item>
            </a-col>
