          ...
          <a-row>
            <a-col :span="24">
              <a-form-model-item label="评分人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="ratingUser">
                <j-select-user-by-dep v-model="model.ratingUser"/>
              </a-form-model-item>
            </a-col>
            <a-col :span="24">
            ...
            <a-col :span="24">
              <a-form-model-item label="评分时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="createTime">
                <j-date placeholder="请选择评分时间" v-model="model.createTime" :show-time="true"
