<template>
  <j-modal
    ...
    <smart-finance-result-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>

  import SmartFinanceResultForm from './SmartFinanceResultForm'
  import {getAction} from "../../../api/manage"

  export default {
    name: 'SmartFinanceResultModal',
    components: {
