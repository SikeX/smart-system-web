<template>
  <j-modal
    ...
    <a-spin tip="Loading..." :spinning="false">
      <a-input-search v-model="searchValue" style="margin-bottom: 1px" placeholder="请输入村镇名进行搜索" />
...
<script>
  import { queryDepartTreeList, queryVillageIdTree } from '@/api/api'
  export default {
    name: 'SelectVillageDepartModal',
